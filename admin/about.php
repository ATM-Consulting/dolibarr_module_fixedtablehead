...
/**
 * \file    fixedtablehead/admin/about.php
 * \ingroup fixedtablehead
 * \brief   About page of module FixedTableHead.
 */
...
// Translations
$langs->loadLangs(array("errors","admin","fixedtablehead@fixedtablehead"));
...
dol_fiche_head($head, 'about', '', 0, 'fixedtablehead@fixedtablehead');

dol_include_once('/fixedtablehead/core/modules/modFixedTableHead.class.php');
$tmpmodule = new modFixedTableHead($db);
