...
/**
 *	\file       htdocs/fixedtablehead/template/fixedtableheadindex.php
 *	\ingroup    fixedtablehead
 *	\brief      Home page of fixedtablehead top menu
 */
...
$langs->loadLangs(array("fixedtablehead@fixedtablehead"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->fixedtablehead->read) accessforbidden();
...
llxHeader("",$langs->trans("FixedTableHeadArea"));

print load_fiche_titre($langs->trans("FixedTableHeadArea"),'','fixedtablehead.png@fixedtablehead');
...
// Draft MyObject
if (! empty($conf->fixedtablehead->enabled) && $user->rights->fixedtablehead->read)
{
	$langs->load("orders");
