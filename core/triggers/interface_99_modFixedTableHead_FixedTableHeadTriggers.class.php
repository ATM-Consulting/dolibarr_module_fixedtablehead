...
/**
 * \file    core/triggers/interface_99_modFixedTableHead_FixedTableHeadTriggers.class.php
 ...
 *      - interface_99_modFixedTableHead_MyTrigger.class.php
...
/**
 *  Class of triggers for FixedTableHead module
 */
class InterfaceFixedTableHeadTriggers extends DolibarrTriggers
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "FixedTableHead triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'fixedtablehead@fixedtablehead';
	}
	...
	{
        if (empty($conf->fixedtablehead->enabled)) return 0;     // Module not active, we do nothing
